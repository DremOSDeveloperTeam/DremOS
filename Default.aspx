...
<ul>
  ...
  <li><a href="old.aspx">Legacy (SUSE) Versions</a></li>
    ...
    <h2>What is DremOS?</h2>
    <p>DremOS is a fast and lightweight OS. It originally started on SUSE Studio, which has since shut down, so since 0.6.0 it has become an Ubuntu distro.</p>
</body>
</html>